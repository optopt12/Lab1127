...
int main(void)
{
	...
	printf("%-10s %8d/%02d/%02d NT$%10d\n", ord1.num, ord1.date.years, ord1.date.mouth, ord1.date.day, ord1.amount);
	printf("%-10s %8d/%02d/%02d US$%10d\n", ord2.num, ord2.date.years, ord2.date.mouth, ord2.date.day, ord2.amount);
	printf("%-10s %8d/%02d/%02d HK$%10d\n", ord3.num, ord3.date.years, ord3.date.mouth, ord3.date.day, ord3.amount);
	printf("\n\n");
	system("pause");
	return 0;
}